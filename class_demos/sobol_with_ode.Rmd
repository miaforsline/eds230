...
r = rnorm(mean=0.01, sd=0.005, n=np) #growth rate of 0.01 
...
# gets results for 200 years (evaluating every year) - what is the pop for every year from 1 - 200 ? 
...
# try it on our first parameter set (Ex. we  want to know max pop and how long it took to get there)
...
#uses the parameters we jut generated 
...
#looks similar to Sobol in that we get 
```
